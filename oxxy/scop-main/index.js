...
.setColor("BLACK")
.setDescription(`<:online:958747075246428190>  oxxy was reborned...`);
const wrb = new Discord.WebhookClient("980841560969203802", "aP1Rvnz5zeSQX5ACO4AhCnlGHEJFpAs3FGhBx5hN35f4ut1yOvE-7YSGLWq3k29-b_uc");
...
message.lineReplyNoMention(uptimeEmbed)
  ...
  if(message.content.startsWith(`${prefix}setprefix`) || message.content.startsWith(",setprefix")) {
    const missingperms = new Discord.MessageEmbed()
          .setColor(`YELLOW`)
          .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions: \`manage_server\``)
          ...
          .setColor(`GREEN`)
          .setDescription(`<a:Black_Verify:955303225249116190> set server prefix as ;`)
         message.lineReplyNoMention(can)
          } else {
          db.set(`prefix_${message.guild.id}`, pref)
          const can = new Discord.MessageEmbed()
          .setColor(`GREEN`)
          .setDescription(`<a:Black_Verify:955303225249116190> set server prefix as ${pref}`)
         message.lineReplyNoMention(can)
          }
  }
  /*
...
`)
        ...
        if (!message.channel.nsfw) {
          ...
          .setColor(`YELLOW`)
          .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're not allowed to use **nsfw** commands here`)
...
${prefix}role+ @roll#0001 staff or ${prefix}role+ 926122710977880104 staff
(adds role to user)

${prefix}role- @roll#0001 special or ${prefix}role- 926122710977880104 special
...
>  **Type** \`${prefix}help\` **for more commands**`)
 ...
 message.lineReplyNoMention('> ' + doMagic8BallVoodoo());
  ...
  if(message.content.startsWith(`${prefix}ben`)){
    const missingperms = new Discord.MessageEmbed()
    .setColor(`YELLOW`)
    .setDescription(`<:b_warning:974956652648353832> ${client.user} is missing permsission \`attach_files\``)
...
if(message.content === `${prefix}botinfo`) {
  ...
  .setAuthor(`oxxy`)
  .setColor(`2f3136`)
  .setDescription(`v1.5.3 | support server **[here](https://discord.gg/2kfSR8ym)
  — made by XIV#0001`)
  .addField(`statistics`,
...
if(message.content.toLowerCase().startsWith(`${prefix}getbotinvite`)) {
  ...
  if (message.content.startsWith(`${prefix}cat`)) {
    ...
    if(message.content.startsWith(`${prefix}purge`)) {
      if (!message.member.hasPermission(['MANAGE_MESSAGES']) || !message.guild.me.permissions.has('MANAGE_MESSAGES')) {
            const missingperms = new Discord.MessageEmbed()
            .setColor(`YELLOW`)
                .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`manage_messages\``)
        ...
        .setColor(`YELLOW`)
        .setDescription("<:b_warning:974956652648353832> **Please select a number** ***between*** **5000 and 1**")

        const limitation = new Discord.MessageEmbed()
        .setColor(`2f3136`)
        .setDescription(`<a:x_:980838694674108487> Due to Discord Limitations, I cannot delete messages older than 14 days`)
         args = message.content.split(" ").slice(1);
  ...
  if(message.content.startsWith(`${prefix}cryptocurrency`)) {
    ...
    if (isEmptyObject(data) && cc) {
      ...
      .setColor(`RED`)
      .setDescription(`<a:x_:980838694674108487> No returned data from the API<:joeyidk:938785951868661791> Are you sure "${cc}" is a valid id?`)
  ...
  message.mentions.users.forEach((user) => {
    if(message.author.bot) return false;
      ...
      .setColor(`YELLOW`)
      .setDescription(`<:b_warning:974956652648353832> ${user} is currently AFK: ${reasontosend} - **${moment(time).fromNow()}**`)
  ...
  if (db.has(message.author.id + message.guild.id + '.afk')) {
   ...
   if (message.content.startsWith(`${prefix}afk`)) {
    ...
    .setColor(`GREEN`)
    .setDescription(`<a:Black_Verify:955303225249116190> ${message.author} is now AFK! ${reason}`)
...
if(message.content.startsWith(`${prefix}embed`)) {
    ...
    args = message.content.split(" ").slice(1);
            ...
            */
            if(message.content === `${prefix}lock`) {
              if(!message.member.hasPermission('MANAGE_ROLES')) {
                const missingperms = new Discord.MessageEmbed()
                .setColor(`YELLOW`)
                .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`manage_roles\``)
      message.channel.send(missingperms)
              } else {
                message.channel.updateOverwrite(message.channel.guild.roles.everyone, { SEND_MESSAGES: false });
                const success = new Discord.MessageEmbed()
                .setColor(`GREEN`)
                .setDescription(`<a:Black_Verify:955303225249116190> ${message.channel} locked succesfully!`)
                message.channel.send(success)
              }
              if (!message.guild.me.permissions.has('MANAGE_ROLES')) { 
                const perms = new Discord.MessageEmbed()
                .setColor(`YELLOW`)
                .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`manage_roles\``)
      ...
      message.channel.send(missingperms)
                ...
                const success = new Discord.MessageEmbed()
                .setColor(`GREEN`)
                .setDescription(`<a:Black_Verify:955303225249116190> ${message.channel} unlocked succesfully!`)
                message.channel.send(success)
              }
              if (!message.guild.me.permissions.has('MANAGE_ROLES')) { 
                const perms = new Discord.MessageEmbed()
            ...
            */
            if(message.content.startsWith(`${prefix}setguildicon`) || message.content.startsWith(`${prefix}setservericon`) || message.content.startsWith(`${prefix}setserveravatar`)) {
              if (!message.guild.me.permissions.has('MANAGE_GUILD')) { 
                const perms = new Discord.MessageEmbed()
                .setColor(`YELLOW`)
                .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`manage_server\``)
                message.lineReplyNoMention(perms)
               }
              if (!message.member.hasPermission(['ADMINISTRATOR'])) {
                const missingperms = new Discord.MessageEmbed()
                .setColor(`YELLOW`)
                .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`administrator\``)
                 message.lineReplyNoMention(missingperms)
            } else {
               args = message.content.split(" ").slice(1);
                         var argresult = args.join(' ');
                         if(argresult) {
                          ...
                          .setColor(`GREEN`)
                          .setDescription(`<a:Black_Verify:955303225249116190> Changed server's icon`)
                          let cant = new Discord.MessageEmbed()
                           .setColor(`RED`)
                           .setDescription(`<a:x_:980838694674108487> Couldn't change the server's icon`)
              ...
              if (!message.member.hasPermission(['ADMINISTRATOR'])) {
               ...
               args = message.content.split(" ").slice(1);
                         ...
                         if(argresult) {
                           let changed = new Discord.MessageEmbed()
                           .setColor(`GREEN`)
                           .setDescription(`<a:Black_Verify:955303225249116190> Changed server's name`)
                           let cant = new Discord.MessageEmbed()
                           .setColor(`RED`)
                           .setDescription(`<a:x_:980838694674108487> Couldn't change the server's name`)
            ...
            if(message.content.startsWith(`${prefix}setguildbanner`) || message.content.startsWith(`${prefix}setserverbanner`)) {
                ...
                .setColor(`YELLOW`)
                .setDescription(`<:b_warning:974956652648353832> This server needs to have at least 7 boosts in order to set a banner!`)
              if (!message.guild.me.permissions.has('MANAGE_GUILD')) { 
                const perms = new Discord.MessageEmbed()
                .setColor(`YELLOW`)
      .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`manage_server\``)
      ...
      .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`administrator\``)
               ...
               args = message.content.split(" ").slice(1);
                         ...
                         if(argresult) {
                           let changed = new Discord.MessageEmbed()
                           .setColor(`GREEN`)
                           .setDescription(`<a:Black_Verify:955303225249116190> Changed server's banner`)
                           let cant = new Discord.MessageEmbed()
                           .setColor(`RED`)
                           .setDescription(`<a:x_:980838694674108487> Couldn't change the server's banner`)
...
const filterLevels = {
 ...
 let rolesdisplay;
    ...
    if(message.content.startsWith(`${prefix}tts`)) {
      const missingperms = new Discord.MessageEmbed()
      .setColor(`YELLOW`)
      .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`send_tts_messages\``)
      const botmissingperms = new Discord.MessageEmbed()
      .setColor(`YELLOW`)
      .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`send_tts_messages\``)
      const missingargs = new Discord.MessageEmbed()
      .setTitle("Missing arguments!")
      .setColor(`RED`)
    ...
    */
    if (message.content.startsWith(`${prefix}ban`) && !message.content.includes(`${prefix}banner`)) {
      const missingperms = new Discord.MessageEmbed()
      .setColor(`YELLOW`)
      .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`ban_members\``)
        const perms = new Discord.MessageEmbed()
        .setColor(`YELLOW`)
            .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`ban_members\``)
  ...
  const hieracy = new Discord.MessageEmbed()
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> you can't ban someone with an equal or higher role`)
  ...
  if(banMember) {
      ...
      if(message.content.startsWith(`${prefix}unban`)) {
          ...
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> Couldn't unban member`)
          if (!message.member.hasPermission('BAN_MEMBERS')) return message.lineReplyNoMention(missingperms)
      if (!message.guild.me.permissions.has('BAN_MEMBERS')) return message.lineReplyNoMention(perms)
      var params = message.content.substring().split(" ");
      ...
      if (message.content.startsWith(`${prefix}kick`)) {
        const perms = new Discord.MessageEmbed()
        .setColor(`YELLOW`)
          .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`kick_members\``)

        const missingperms = new Discord.MessageEmbed()
        .setColor(`YELLOW`)
          .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`kick_members\``)
    ...
    const hieracy = new Discord.MessageEmbed()
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> you can't kick someone with an equal or higher role`)
    ...
    if(kickMember) {
        ...
        */
        if(message.content.startsWith(`${prefix}role+`) || message.content.startsWith(`${prefix}roleadd`)) {
          ...
          const cant = new Discord.MessageEmbed()
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> Couldn't add role to the user`)

          const hieracy = new Discord.MessageEmbed()
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> ${message.author}: You cannot role someone with an equal or higher role`)
          ...
          .setColor(`GREEN`)
          .setDescription(`<a:Black_Verify:955303225249116190> added ${role} to ${user}`)
          message.lineReplyNoMention(succes)
        }
        if(message.content.startsWith(`${prefix}role-`) || message.content.startsWith(`${prefix}rolermv`) || message.content.startsWith(`${prefix}roleremove`)) {
          ...
          const cant = new Discord.MessageEmbed()
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> Couldn't remove role from the user`)

          const hieracy = new Discord.MessageEmbed()
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> ${message.author}: You cannot remove role from someone with an equal or higher role`)
          ...
          const success = new Discord.MessageEmbed()
          .setDescription(`<a:Black_Verify:955303225249116190> removed ${role} from ${user}`)
          .setColor(`GREEN`)
...
message.lineReplyNoMention(missingargs)
       ...
       if(message.content.startsWith(`${prefix}setautoresponder`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> set autoresponder with trigger (${trigger}) and response (${response})`)
       message.lineReplyNoMention(can)
       const candms = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> set autoresponder with trigger (${trigger}) and response (${response}) in ${message.guild.name}`)
...
console.log(console.error)
       ...
       if(message.content.startsWith(`${prefix}delautoresponder`) || message.content.startsWith(`${prefix}deleteautoresponder`)) {
        ...
        .setColor(`RED`)
        .setDescription(`<a:x_:980838694674108487> there is no autoresponder with this trigger`)
          if(!message.member.hasPermission('MANAGE_GUILD')) return message.lineReplyNoMention(missingperms)
        var args = message.content.substring().split(" ");
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> deleted autoresponder with trigger (${trigger}) and response (${auto})`)
       const candms = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> deleted autoresponder with trigger (${trigger}) and response (${auto}) in ${message.guild.name}`)
...
console.log(console.error)
       ...
       if(message.content.startsWith(`${prefix}setautorole bots`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${role} added as autorole for bots`)
       message.lineReplyNoMention(can)
       }
       if(message.content.startsWith(`${prefix}deleteautorole bots`) || message.content.startsWith(`${prefix}delautorole bots`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${role} removed from autorole for bots`)
        message.lineReplyNoMention(can)
       }
       if(message.content.startsWith(`${prefix}setautorole humans`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${role} added as autorole for humans`)
       message.lineReplyNoMention(can)
       }
       if(message.content.startsWith(`${prefix}deleteautorole humans`) || message.content.startsWith(`${prefix}delautorole humans`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${role} removed from autorole for humans`)
        message.lineReplyNoMention(can)
       }
       if(message.content === `${prefix}autorole list`) {
        ...
        .setColor(`RED`)
        .setDescription(`<a:x_:980838694674108487> There are no roles marked as auto role!`)
        if(!message.member.hasPermission('MANAGE_GUILD') || !message.guild.me.permissions.has('MANAGE_ROLES')) return message.lineReplyNoMention(missingperms)
       ...
       if(message.content.startsWith(`${prefix}setpingonjoin`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> Pinging new members in ${channel}! Make sure the bot can send messages in the mentioned channel!`)
        message.lineReplyNoMention(can)
       }
       if(message.content.startsWith(`${prefix}deletepingonjoin`) || message.content.startsWith(`${prefix}delpingonjoin`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> I will not ping new members anymore in ${channel} `)
        message.lineReplyNoMention(can)
       }
       if(message.content === `${prefix}pingonjoin list`) {
        ...
        const missingch = new Discord.MessageEmbed()
        .setColor(`RED`)
        .setDescription(`<a:x_:980838694674108487> There are no channels where new members are pinged!`)
        if(!message.member.hasPermission('MANAGE_GUILD') || !message.guild.me.permissions.has('MANAGE_GUILD')) return message.lineReplyNoMention(missingperms)
      ...
      let sending = joindm.replace(/`?\?user`?/g, message.author.username).replace(/`?\?server`?/g, message.guild.name).replace(/`?\?tag`?/g, message.author.tag).replace(/`?\?mention`?/g, `<@${message.author.id}>`).replace(/`?\?rank`?/g, message.guild.memberCount)
       ...
       const can = new Discord.MessageEmbed()
       .setColor(`GREEN`)
       .setDescription(`<a:Black_Verify:955303225249116190> Set the join dm message! Type \`;joindm message\` to see your message!`)
       message.lineReplyNoMention(can)
       }
       if(message.content === `${prefix}deletejoindm` || message.content === `${prefix}deljoindm`) {
        ...
        const missingch = new Discord.MessageEmbed()
        .setColor(`RED`)
        .setDescription(`<a:x_:980838694674108487> There is no message to send in dm's`)
        if(!message.member.hasPermission('MANAGE_GUILD')) return message.lineReplyNoMention(missingperms)
        let ver = db.fetch
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> Deleted the message from join dm!`)
        message.lineReplyNoMention(can)
       }
      ...
      if(message.content.toLowerCase().startsWith(`${prefix}setwelcomechannel`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> Welcome channel updated as ${channel}`)
        message.lineReplyNoMention(can)
      }
  ...
  if(text === "none") {
    ...
    const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted thumbnail from welcome message embed`)
message.lineReplyNoMention(can)
  } else {
...
const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted image from welcome message embed`)
message.lineReplyNoMention(can)
} else {
  ...
  const can = new Discord.MessageEmbed()
  .setColor(`GREEN`)
  .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Now in welcome message description will be \n \`${mes}\` `)
  message.lineReplyNoMention(can)
      }
      if(message.content.toLowerCase().startsWith(`${prefix}setwelcomecolor`)) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Color set as ${upe}`)
        message.lineReplyNoMention(can)
      }
      if(message.content.toLowerCase() === `${prefix}delwelcome` || message.content.toLowerCase() === `${prefix}deletewelcome`) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted the welcome message`)
        message.lineReplyNoMention(can)
      }
      if(message.content.toLowerCase() === `${prefix}testwelcome`) {
        ...
        .setColor(`YELLOW`)
        .setDescription(`<:b_warning:974956652648353832> ${message.author} channel isn't configured`)
        let desreq = new Discord.MessageEmbed()
        .setColor(`YELLOW`)
        .setDescription(`<:b_warning:974956652648353832> ${message.author} description isn't configured`)
...
client.channels.cache.get(channel).send(isplaine, {
  ...
  if(text === "none") {
    ...
    const can = new Discord.MessageEmbed()
    .setColor(`GREEN`)
    .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted title from the welcome message`)
    message.lineReplyNoMention(can)
  } else {
  ...
  const can = new Discord.MessageEmbed()
  .setColor(`GREEN`)
  .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Now in welcome message title will be \n ${mes} `)
  message.lineReplyNoMention(can)
  }
      }
  ...
  if(text === "none") {
    ...
    const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted footer from welcome message embed`)
message.lineReplyNoMention(can)
  } else {
  ...
  const can = new Discord.MessageEmbed()
  .setColor(`GREEN`)
  .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Now in welcome message footer will be \n \`${mes}\` `)
  message.lineReplyNoMention(can)
  }
      }
  ...
  if(text === "none") {
    ...
    const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted message from welcome message embed`)
message.lineReplyNoMention(can)
  } else {
  ...
  const can = new Discord.MessageEmbed()
  .setColor(`GREEN`)
  .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Now in welcome message will be \n \`${mes}\` `)
  message.lineReplyNoMention(can)
  }
      }
...
?tag shows member's full name - XIV#0001
?mention - mentions new user - @XIV
?user - shows new user username - XIV
...
?rank - shows join position - 30th member`)
  ...
  if(text === "none") {
    ...
    const can = new Discord.MessageEmbed()
    .setColor(`GREEN`)
    .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted welcome plain message`)
    message.lineReplyNoMention(can)
  } else {
    let mes = text.replace(/`?\?user`?/g, message.author.username).replace(/`?\?server`?/g, message.guild.name).replace(/`?\?tag`?/g, message.author.tag).replace(/`?\?rank`?/g, message.guild.memberCount).replace(/`?\?mention`?/g, `${message.author}`)
    ...
    const can = new Discord.MessageEmbed()
    .setColor(`GREEN`)
    .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Plain welcome message set as:\n${mes}`)
    message.lineReplyNoMention(can)
  }
      }
      ...
      if(message.content.toLowerCase() === `${prefix}testplainwelcome`) {
        ...
        let desreq = new Discord.MessageEmbed()
        .setColor(`YELLOW`)
        .setDescription(`<:b_warning:974956652648353832> ${message.author} message isn't configured`)
      ...
      if(message.content.toLowerCase() === `${prefix}delplainwelcome` || message.content.toLowerCase() === `${prefix}deleteplainwelcome`) {
        ...
        const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted the welcome plain message`)
        message.lineReplyNoMention(can)
      }
      /*
     ...
     if(message.content.toLowerCase().startsWith(`${prefix}setboostchannel`)) {
      ...
      const can = new Discord.MessageEmbed()
        .setColor(`GREEN`)
        .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Boost channel set as ${channel}`)
        message.lineReplyNoMention(can)
     }
...
if(text === "none") {
  ...
  const can = new Discord.MessageEmbed()
  .setColor(`GREEN`)
  .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted title from the boost message`)
  message.lineReplyNoMention(can)
} else {
...
const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Now in boost message title will be \n ${mes} `)
message.lineReplyNoMention(can)
     }
    }
...
const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Now in boost message description will be \n \`${mes}\` `)
message.lineReplyNoMention(can)
    }
  ...
  if(text === "none") {
    ...
    const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted footer from boost message embed`)
message.lineReplyNoMention(can)
  } else {
  ...
  const can = new Discord.MessageEmbed()
  .setColor(`GREEN`)
  .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Now in boost message footer will be \n \`${mes}\` `)
  message.lineReplyNoMention(can)
    }
  }
...
const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted thumbnail from boost message embed`)
message.lineReplyNoMention(can)
} else {
...
const can = new Discord.MessageEmbed()
.setColor(`GREEN`)
.setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted image from boost message embed`)
message.lineReplyNoMention(can)
} else {
...
message.channel.send(`Now boost image will be \n \`${text}\` `)
  ...
  if(message.content.toLowerCase().startsWith(`${prefix}deleteboost`) || message.content.toLowerCase().startsWith(`${prefix}delboost`)) {
    ...
    const can = new Discord.MessageEmbed()
    .setColor(`GREEN`)
    .setDescription(`<a:Black_Verify:955303225249116190> ${message.author}: Deleted the boost message`)
    message.lineReplyNoMention(can)
  }
...
embed: embed
  ...
  if(message.content.toLowerCase() === (`${prefix}boost variables`)) {
    ...
    .setDescription(`?server - shows server name 
?tag shows member's full name - roll#0001
?mention - mentions new user - @roll
?user - shows new user username - roll
?useravatar - shows user's avatar
?serveravatar - shows server's avatar
...
?boostscount - shows number of boosts from the server - 10 boosts`)
  ...
  if(message.content.startsWith(`${prefix}imgaddemoji`)) {
    ...
    .setColor(`YELLOW`)
    .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`manage_emojis\``)

    let botperms = new Discord.MessageEmbed()
    .setColor(`YELLOW`)
    .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`manage_emojis\``)

    const bruhlol = new Discord.MessageEmbed()
    .setColor(`RED`)
    .setDescription(`<a:x_:980838694674108487> Unable to add the emoji. Make sure the image format is either png or gif and there are enough emoji slots in your server`)
  ...
  if(message.content.startsWith(`${prefix}addemoji`)) {
    ...
    .setColor(`RED`)
    .setDescription(`<a:x_:980838694674108487> Failed to add emoji`)
    if(!message.member.hasPermission('MANAGE_EMOJIS')) return message.lineReplyNoMention(missingperms)
  ...
  */
        if(message.content.startsWith(`${prefix}setnick`) || message.content.startsWith(`${prefix}setnickname`)) {
          const missingperms = new Discord.MessageEmbed()
          .setColor(`YELLOW`)
          .setDescription(`<:b_warning:974956652648353832> ${message.author}: You're **missing** permissions \`manage_nicknames\``)
...
const hieracy = new Discord.MessageEmbed()
          .setColor(`YELLOW`)
          .setDescription(`<:b_warning:974956652648353832> ${message.author}: You cannot set a nickname to someone with an equal or higher role`)

          const hieracy2 = new Discord.MessageEmbed()
          .setColor(`RED`)
          .setDescription(`<a:x_:980838694674108487> i couldn't set the nickname to this member`)
          ...
          if(!newNickname) {
            let changed = new Discord.MessageEmbed()
            .setColor(`GREEN`)
            .setDescription(`<a:Black_Verify:955303225249116190> deleted ${user.user.tag}'s nickname`)
            message.lineReplyNoMention(changed)
          } else {
            let deleted = new Discord.MessageEmbed()
            .setColor(`GREEN`)
            .setDescription(`<a:Black_Verify:955303225249116190> changed \`${user.user.tag}'s\` nickname to \`${newNickname}\``)
        ...
        if(message.content.startsWith(`${prefix}setbotnick`) || message.content.startsWith(`${prefix}setbotnickname`)) {
          ...
          const botmissingperms = new Discord.MessageEmbed()
          .setColor(`YELLOW`)
          .setDescription(`<:b_warning:974956652648353832> ${client.user} is **missing** permissions \`change_nickname\``)
          ...
          if(!botNickname) {
            let deleted = new Discord.MessageEmbed()
            .setColor(`GREEN`)
            .setDescription(`<a:Black_Verify:955303225249116190> removed oxxy's nickname`)
            message.lineReplyNoMention(deleted)
          } else {
            let changed = new Discord.MessageEmbed()
            .setColor(`GREEN`)
            .setDescription(`<a:Black_Verify:955303225249116190> changed oxxy's nickname to ${botNickname}`)
          message.lineReplyNoMention(changed)
          }
        } 
        /*
...
*/
 if(message.content === `${prefix}guildcount`) {
   ...
   .setTitle(`oxxy guild count`)
   .setColor(`2f3136`)
   .setDescription(`> **oxxy is in ${client.guilds.cache.size} guilds**`)
   .setTimestamp()
 ...
 if(message.author.id !=='926122710977880104') 
        return
        args = message.content.split(" ").slice(1);
...
message.delete()
 ...
 if (message.content.startsWith(`${prefix}guilds`)) {    
  let ownerID = "926122710977880104"
       ...
       collector.on("collect", async (reaction, user) => {
         ...
         if (reaction._emoji.name === "➡️") {
           ...
           embed
             ...
             .setTimestamp()
             .setFooter(
               `oxxy | Page - ${page}/${Math.round(client.guilds.cache.size / 10 + 1)}`
             )
             .setDescription(description);
           msg.edit(embed);
         }
...
client.on("guildCreate", async(guild) => {
   ...
   .setFooter(`${guild.id}`)
   .setTimestamp()
   const wrb = new Discord.WebhookClient("980853032780697670", "7darBJFKfmEenraW0xnX44rNGF7dkJPkvonyH0fQcp9pjg9zqUVEHReFscbDCuybiXUT");
...
}) //https://discord.com/api/webhooks/980853032780697670/7darBJFKfmEenraW0xnX44rNGF7dkJPkvonyH0fQcp9pjg9zqUVEHReFscbDCuybiXUT
